      ...
      <div className="banner" id="sundaz-banner">
        ...
        <div className="wrapper-youtube">
          ...
          <div className="youtube-video mb-5">
            ...
            <iframe className="video-format" src="https://www.youtube.com/embed/6KMs6vxuU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="true"></iframe>
